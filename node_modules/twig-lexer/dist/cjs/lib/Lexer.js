...
exports.Lexer = exports.whitespacePattern = exports.stringPattern = exports.punctuationPattern = exports.numberPattern = exports.namePattern = exports.lineSeparators = exports.doubleQuotedStringDelimiterPattern = exports.doubleQuotedStringContentPattern = exports.bracketPairs = void 0;
...
class Lexer {
    ...
    tokenize(source) {
        ...
        this.tagEndRegExp = new RegExp('^(' + this.trimmingModifier + '?)(' + this.tagPair[1] + '(?:' + exports.lineSeparators.join('|') + ')?)' +
            '|' +
            '^(' + this.lineTrimingModifier + ')(' + this.tagPair[1] + ')');
        this.commentEndRegExp = new RegExp('(\\s*)(' + this.trimmingModifier + '?)(' + this.commentPair[1] + '(?:' + exports.lineSeparators.join('|') + ')?)' +
            '|' +
    ...
    lexExpression() {
        ...
        if (this.level === 3
            ...
            && this.cursor + 2 < this.end
            && this.source[this.cursor + 1] === '.'
            && this.source[this.cursor + 2] === '.') {
        ...
        // unlexable
            ...
            throw new SyntaxError_1.SyntaxError(`Unexpected character "${singleCharacterCandidate}".`, this.line, this.column);
        }
    }
    lexTag() {
        this.lexWhitespace();
